...
# go-commands.lua (Comandos útiles para Go)
cat > "$CONFIG_DIR/lua/plugins/go-commands.lua" << 'EOF'
-- ~/.config/nvim/lua/plugins/go-commands.lua
return {
  -- Plugin simple para comandos de Go
